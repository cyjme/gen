...
var rootCmd = &cobra.Command{
	Use:   "gen",
	Short: "Auto create golang api project (gin+gorm+swagger), quickly build restful api and document",
	Long: `Auto create golang api project (gin+gorm+swagger), quickly build restful api and document.
